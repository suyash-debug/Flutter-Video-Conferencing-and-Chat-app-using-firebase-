import 'package:edits/src/pages/signup.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  signIn(context, GlobalKey<ScaffoldState> scaffoldKey) async {
  ...
  Widget _buildSocialBtn(AssetImage logo) {
    return GestureDetector(
      onTap: () async {
        ...
        print(res);
        print('this is to check wheather id is being stored or not');
      },
      child: Container(
        height: 60.0,
        width: 60.0,
